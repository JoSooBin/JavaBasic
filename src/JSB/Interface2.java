...
//인터페이스는 대상을 바라보는 관점으로 설명 할 수 있음
//1. 식당에서 한끼를 해결하려는 손님 입장에서 "불닭 돈까스"는 하나의 메뉴임
...
//대부분의 음식점에서  "불닭돈까스"를 요리하고있음
//하지만 요리사의역량에 따라 기본은 지켜하면서 제각각의 결과물을 만들어 냄
//어느 음식점을 가더라도 조금의 차이는 존재하지만 불닭돈까스라는 음식은 비슷하게 만들어내고있음

//기본base클래스
//인터페이스를 구현하면 자식클래스에는 추상 메서드를 반드시 재정의 해야함
...
class Cat4 extends Animal4Base { } //43~줄을 불러옴 재정의를 간단히 할 수 있음(코드는 늘어나나 편의성 증가)
