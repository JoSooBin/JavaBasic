...
//상속(확장)
//객체지향 3대 개념 중 하나
//기존 클래스에 기능을 추가하거나 재정의해서 새로운 클래스를 만드는 것
//상속을 이용하려면 기존의 정의되어있는 클래스의 모든 필드와 메서드를 물려받음
...
class  Persons {
    ...
    public String spedk() {return  "말하는 중..."; }
...
class StudntWorker extends Students {
    public String working() { return  "나는 일하는 중....";}
}
class Researcher extends Persons {
    public String research() { return  "나는 연구하는 중....";}
}
class Professor extends Researcher {
    public String teach() { return  "나는 가르치는 중....";}
}