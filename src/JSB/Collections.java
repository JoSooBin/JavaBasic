...
public class Collections {
    public static void main(String[] args) {
        ...
        //동물들을 동물원 우리에 가둠
        //일반적으로 배열은 동일한 유형의자료들을 저장하는 자료구조
        ...
        //Zebra l1 = zoo[1];
        Zebra z1 = (Zebra) zoo[1];

        //컬렉션 프레임워크
        //다수의 데이터를 쉽고 효과적으로 처리할 수 있도록 표준화방법을 제공하는 클래스
        //데이터를 저장하는 자료구조와 처리하는 각종 알고리즘을 구조화하여 클래스로 구현해 놓은 것
        //동적배열, 집합, 해시맵, 트리, 큐
        ArrayList zoo2 = new ArrayList();
        //컬렉션 프레임워크에서 제공하는 동적배열
        //동적배열의 자료형은 기본적으로 Object
        zoo2.add(new Tiger()); //add : 배열에 넣는다
        zoo2.add(new Lion());
        zoo2.add(new Zebra());
        ...
        //l1 = zoo2.get(1);
        //z1 = zoo2.get(2);
        //동적 배열을 사용했지만 앞의 경우와 동일하게 형변환시 오류발생

        //지네릭을 이용하면 데이터의 타입을 통일시켜
        //컴파일시 타입체크 오류방지와 불필요한 형변환을 없앨 수 있음
        //type-parameter (<>)를 이용해서 자료구조의 데이터 유형을 미리 설정해 둠
        ArrayList<Tiger> zoo3 = new ArrayList<>();
        zoo3.add (new Tiger());
        //zoo3.add (new Zebra()); //오류발생
        t1 = zoo3.get(0); //자동으로 형변환 되기 때문에 오류 없이 처리가능
