...
//요소의 저장 순서가 유지
//중복으로 데이터를 저장 할 수 있음
//크키가 늘어나면 새로운 배열을 생성하고 기존의 요소들을 옮겨야하는 복잡한 과정이 동반됨.
public class ArrayLists {
    public static void main(String[] args) {
        ...
        //데이터 검색하기
        //배열에서 원하는 데이터를 찾는 방법 2가지
        //위치로 찾음 : get(위치)
        //실제값으로 찾음 : contains, indexOf
        String[] game = {"스타크래프트","디아블로","워크래프트"};
        //ArrayList<String> games = (ArrayList<String>) Arrays.asList(game); //문법적으로는 문제 없지만 실행시 다운캐스팅 오류 발생
        List<String> games = Arrays.asList(game);
        //일반배열을 동적 배열로 변환하려면
        //Arrays 클래스이 asList메서드를 사용함
        System.out.println(games);
        System.out.println("-------------------");

        //games 동적배열에서 '스타크래프트'를 찾아봄
        //전체를 훑어가며 대상을 찾기때문에 성능을 나쁨
        //위치기반 검색
        ...
        //위치 기반 검색
        System.out.println(games.indexOf("디아블로")+1);
        System.out.println("-------------------");
        ...
        //스타크래프트 요소를 출력
        //ArrayList의 타입이 GameInfo의 객체이므로 GameInfo 객체의 주소가 저장됨.
        System.out.println(games2.get(1)); //주소만 출력
        System.out.println("-------------------");

        //따라서, GameInfo 객체의 실제값을 출력하려면
        //객체명.변수명 또는 대상.getter를 이용해야 함
