...
public class SamKwangJDBC extends JDBCUtil {
    ...
    public static String selectSOE = " select 인사번호, 주문번호, 운송ID, 운송이름, 주문일, 직책 from SOE order by 운송ID desc ";
    public static String selectONESOE = " select * from SOE where 운송ID = ? ";
}
